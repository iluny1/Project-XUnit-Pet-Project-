...
public class Pathfinding : MonoBehaviour
{
    ...
    [SerializeField] private LayerMask oLayerMask;
    ...
    public void Setup(int width, int height, float cellSize)
    {
        ...
        for (int x = 0; x < width; x++)
        {
            for (int z = 0; z < width; z++)
            {
                ...
                bool isObstacle = Physics.Raycast(worldPosition + Vector3.down * raycastOffset, Vector3.up, raycastOffset * 2, oLayerMask);
    ...
    public int CalculateDistance(GridPosition gridPositionA, GridPosition gridPositionB)
    {
        ...
        int result = MOVE_DIAGONAL_COST * Mathf.Min(xDistance, zDistance) + MOVE_STRAIGHT_COST * remaining;
        return result;
    }
